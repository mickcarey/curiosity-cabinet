...
- OpenStax, [Biology 2e: cell structure](https://openstax.org/books/biology-2e/pages/4-introduction) and [cell reproduction](https://openstax.org/books/biology-2e/pages/10-introduction).
- Alberts et al., *Molecular Biology of the Cell* — membranes, organelles, transport and cell-cycle control.
- Sagan [Margulis] (1967), [On the origin of mitosing cells](https://pubmed.ncbi.nlm.nih.gov/11541392/).
- Kerr, Wyllie & Currie (1972), *Apoptosis: a basic biological phenomenon with wide-ranging implications in tissue kinetics*.
