...
## 🐚 Use organisms as evidence with limits

A living, established organism shows that it has survived the conditions it encountered so far. A reproducing population provides stronger evidence of a viable habitat over time.
...
The prediction becomes specific: if light is the main limitation, comparable sites with better light should be more favourable, provided other requirements are met. A sentence that can fail a check is more useful than “seagrass likes clean water.”
...
[Port Phillip kelp restoration](https://www.natureaustralia.org.au/what-we-do/our-priorities/oceans/ocean-stories/kelp-forest-in-port-phillip-bay/) provides a practical example of work addressing grazing and kelp establishment. It is evidence from particular projects, not permission to assume every bare reef has the same history.
...
Not seeing an organism can mean it is absent, concealed, inactive, seasonally elsewhere or simply missed.

Before treating absence as an ecological signal, ask whether the survey could reasonably detect the organism. A low-tide walk cannot census every fish using the same habitat at high tide. A photograph of sediment cannot reveal all the animals buried beneath it.

Repeated observations under comparable conditions improve confidence. Historical records can establish that a habitat was once present, but differences in mapping methods need attention too. [Coastal animals](coastal-animals.md) describes several common observation biases.
...
This parallels [choosing plants on land](../forests/choosing-plants.md). A suitable climate does not make every planting ecologically appropriate, and a plausible marine habitat does not justify moving organisms into it.

## 📓 Keep a short evidence trail

A useful note separates three layers:

> **Observed:** seagrass occupied the shallow sheltered margin on this visit.
>
> **Inferred:** the combination of light, sediment stability and exposure permits growth there.
>
...
- Bureau of Meteorology, [Tides and sea level](https://www.bom.gov.au/resources/learn-and-explore/marine-knowledge-centre/tides-and-sea-level).
- The Nature Conservancy Australia, [Restoring kelp forests in Port Phillip Bay](https://www.natureaustralia.org.au/what-we-do/our-priorities/oceans/ocean-stories/kelp-forest-in-port-phillip-bay/).
- Great Barrier Reef Marine Park Authority, [Reef building](https://outlookreport.gbrmpa.gov.au/values/3-ecosystem-health/34-ecological-processes/348-reef-building) — net carbonate accumulation, rather than coral presence alone.
