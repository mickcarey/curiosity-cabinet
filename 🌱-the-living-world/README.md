...
*From atoms to forests, oceans, and other planets — a field guide for people who have been alive this whole time and would like, at last, to know what that actually means*

You have been running a chemical process for years without reading the manual. The manual, inconveniently, is written in molecules, then cells, then guts, then trees, then tides, then spectra from someone else's sky. This series is the translation.

I am the AI narrator on this expedition. Mick is the human who asked for a really deep dive and then, because he cannot leave a good idea sitting quietly, also asked for the ocean, space, other planets, and how we would know if anyone else is home. Fair. Life does not stop at the car park.

## The Thesis 🧬

Life is not a thing you can put in a jar and label. It is a **process** that does three moves, over and over:

1. **Capture energy** — sunlight, food, a vent, a gradient. Something has to pay the bill.
2. **Copy information** — DNA, RNA, and the messy family of almost-codes. Something has to remember.
3. **Build structure** — proteins, membranes, bones, leaves, reefs, bodies. Something has to *be there*.

Once you can see those three moves, you can read a cell, a breakfast, a forest, a rockpool, or a wiggle in a telescope. The scenery changes. The game does not.

A calorie is a unit of that game. A gene is a sentence in it. A eucalypt is a slow argument with fire and poor soil. A barnacle line is a tide table written in calcium. An oxygen-rich exoplanet atmosphere is the same argument, shouted across light-years, and we still might be hearing the plumbing.

## How To Wander 🗺️

This is a climb, not a prison.
...
- [Reading The Bush](../🌲-reading-the-bush/README.md) — south-east Australia, tree → soil → what could grow here
- [Reading The Water](../🌊-reading-the-water/README.md) — the same literacy for coasts, rockpools, and estuaries

The science series teaches the method. The companions take it outside. Other planets do not get a walkable companion. Earth is the place with tracks.
...
- Not a foraging guide. If you eat a mushroom because a sentence here felt confident, you have misunderstood both the sentence and the mushroom.
- Not a UFO subreddit with footnotes. The alien question is chemistry, false positives, and patience.

If a paragraph could be swapped for a first-year lecture transcript, it has failed. If the joke leaps in front of the idea wearing tap shoes, the tap shoes go. The idea stays.
...
## Already In The Cabinet 🗄️

This series does not absorb its neighbours. It puts doors in.

| If you want… | Go here first |
|---|---|
| Joints, injury, not breaking yourself | [The Magnificent Machine](../📰-articles/health-fitness-anatomy.md) |
| ATP for training, not for chemistry class | [The Long Game](../📰-articles/health-fitness-endurance.md) |
| Trees talking underground | [The Fungal Network](../✈️-airplane-reading/the-fungal-network-beneath-our-feet.md) |
| A jellyfish with a reset button | [The Immortal Jellyfish](../✈️-airplane-reading/the-immortal-jellyfish.md) |
| A brain that refuses to sit in one skull | [Octopus Intelligence](../✈️-airplane-reading/the-mystery-of-octopus-intelligence.md) |
| Carbon falling through the dark | [Marine Snow](../🌙-bedtime-reading/marine-snow-the-oceans-slow-blizzard.md) |
| Where is everybody? | [The Fermi Paradox](../💡-concepts/fermi-paradox.md) |
| A star that made astronomers check their homework | [Tabby's Star](../✈️-airplane-reading/tabbys-star.md) |
| Spacetime, not biology | [Origins And Limits Of The Universe](../📰-articles/origins-and-limits-of-the-universe.md) |
| Walks near Melbourne, as *places* | [Melbourne Hikes](../🏙️-melbourne/hikes.md) |

## The Stance On Not Knowing 🔭

Every chapter is supposed to have a **Still Unsolved** corner. That is not a vibe. It is the point.

School biology often ends like a sitcom: the credits roll, the lesson is complete, nobody mentions that we still cannot define life, cannot culture most of the soil, and cannot tell a biosignature from a weird rock without a fight. This series keeps the credits off. Known unknowns are first-class results. Theories are labelled as theories. Swagger is for the jokes, not the claims.

## Things To Look At Later 📚

Name-drops worth chasing when the chapters start landing:
...
- The Venus phosphine papers, both the claim and the hangover

MC can treat those as a future reading pile, not homework due Tuesday.
