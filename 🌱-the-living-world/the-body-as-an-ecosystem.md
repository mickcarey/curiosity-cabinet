...
A microbe's influence is not proportional to its body mass. Small populations can have substantial chemical effects, while abundant organisms may be functionally interchangeable for a particular process.
...
Animal experiments can test mechanisms that human observational studies cannot, but results do not automatically transfer between species or settings. The fascinating question is which specific pathways matter under which conditions, rather than whether microbes secretly run the entire person.
...
- Cannon (1929), *Organization for physiological homeostasis* — the classical account of coordinated internal regulation.
- OpenStax, [Anatomy and Physiology 2e](https://openstax.org/details/books/anatomy-and-physiology-2e) — organ-system mechanisms.
- Sender, Fuchs & Milo (2016), [Revised estimates of human and bacterial cell numbers](https://pmc.ncbi.nlm.nih.gov/articles/PMC4991899/).
- Byrd, Belkaid & Segre (2018), [The human skin microbiome](https://www.nature.com/articles/nrmicro.2017.157).
- Pontzer et al. (2016), [Metabolic acceleration and human evolution](https://pmc.ncbi.nlm.nih.gov/articles/PMC4942851/).
